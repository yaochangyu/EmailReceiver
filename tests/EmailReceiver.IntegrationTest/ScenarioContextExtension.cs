...
public static class ScenarioContextExtension
{
    ...
    public static IDbContextFactory<EmailReceiverDbContext> GetMemberDbContextFactory(this ScenarioContext context)
    {
        return GetServiceProvider(context).GetService<IDbContextFactory<EmailReceiverDbContext>>();
    }
